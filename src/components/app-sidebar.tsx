          ...
          <SidebarMenuItem>
            <DropdownMenu>
              <DropdownMenuTrigger asChild>
                ...
                >
                  <span className="w-9 h-9 aspect-square rounded-full bg-gold/90 text-gold-foreground inline-flex items-center justify-center text-xs font-semibold shrink-0 leading-none ring-1 ring-gold/40">
                    {initial}
                  </span>
                  {!collapsed && (
                    <>
