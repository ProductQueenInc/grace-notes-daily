...
export function FeedbackDialog() {
  ...
  return (
    <Dialog open={open} onOpenChange={(v) => { if (!v) closeFeedback(); }}>
      ...
      */}
      <DialogContent className="max-w-lg p-0 overflow-hidden bg-background flex flex-col max-h-[85svh] sm:max-h-[85vh] rounded-2xl gap-0">
        ...
        {formId && (
          <iframe
            ...
            title="Feedback form"
            loading="lazy"
            className="w-full flex-1 min-h-[420px] border-0 bg-transparent"
          />
        )}
      </DialogContent>
    </Dialog>
