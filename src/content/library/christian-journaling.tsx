  ...
  return (
    <>
      <div className="glass-parchment rounded-3xl p-8 md:p-10 space-y-5">
        ...
        <p className="text-foreground/75 leading-relaxed">
          The Bible's longest book is a model for Christian journaling, and it doesn't look like the sanitised version of faith we sometimes perform for ourselves. It looks like someone talking honestly to God about everything.
        </p>
      </div>

      <div className="glass-parchment rounded-3xl p-8 md:p-10 space-y-5">
        <h2 className="font-display text-3xl text-grace">The writer who didn't clean it up first</h2>
        <p className="text-foreground/75 leading-relaxed">
        ...
        <p className="text-foreground/75 leading-relaxed">
          Jeremiah didn't resolve the tension before he wrote it down. He wrote through it, all of it, and arrived somewhere on the other side. That's what journaling can do. It doesn't require a tidy faith before you begin. It gives you a space to work out what you actually believe in the presence of God, who already knows what is in you and isn't surprised by any of it.
        </p>
        <p className="text-foreground/75 leading-relaxed">
          Christian journaling isn't about producing beautiful writing or maintaining a record of spiritual victories. It's the conversation: ongoing, honest, sometimes messy, with a God who invites you to come as you are, not as you intend to be.
        </p>
      </div>

      <div className="glass-parchment rounded-3xl p-8 md:p-10 space-y-5">
        <h2 className="font-display text-3xl text-grace">What tends to end up on the page</h2>
        <p className="text-foreground/75 leading-relaxed">
          The journal space is where you stop performing your faith and start writing it honestly. The doubt, the frustration, the honest desire for something that hasn't come yet. Not because God needs to be informed, but because you need to say it, and saying it to God changes something in you that saying it elsewhere doesn't.
        </p>
        <p className="text-foreground/75 leading-relaxed">
          You can write things you wouldn't say out loud. The journal is private, and God already knows what is in you. There's no confession you could write that would change how He sees you. There is only the relief of having said it, and the surprising thing that often happens next: clarity. Or peace. Or a verse you haven't thought of in years that rises up from somewhere and says exactly the right thing.
        </p>
        <p className="text-foreground/75 leading-relaxed">
          Come back and read old entries. Six months from now, a year from now, you'll read something you wrote in a difficult moment and realise it was actually the beginning of something. The entries from hard seasons sit alongside the entries from breakthrough ones, and together they show you something you cannot see in real time: a God who was present in all of it. A faith that is genuinely yours, not borrowed from someone else's story.
        </p>
        <p className="text-foreground/75 leading-relaxed">
          That's what journals do. They hold the beginnings we don't recognise as beginnings until later.
        </p>
      </div>

      <div className="glass-parchment rounded-3xl p-8 md:p-10 space-y-5">
        <h2 className="font-display text-3xl text-grace">On how it actually works</h2>
        <p className="text-foreground/75 leading-relaxed">
          Your journal in GraceNotes Daily is separate from your prayer space, and that distinction is intentional. Prayers are for specific, direct asks: a clear request, a particular need, something you can one day mark as answered. The journal is for everything else: the processing, the longer thoughts, the things you are still working through. Both matter; they just serve different purposes.
        </p>
        <p className="text-foreground/75 leading-relaxed">
          You don't need to write beautifully. You don't need complete thoughts or correct theology or a structured entry. The only thing a journal requires is honesty. Write what is true for you today, in whatever words you have for it.
        </p>
      </div>

      <div className="glass-parchment rounded-3xl p-8 md:p-10 space-y-5">
        <h2 className="font-display text-3xl text-grace">Where it all lives</h2>
        <p className="text-foreground/75 leading-relaxed">
        ...
        <p className="text-foreground/75 leading-relaxed">
          Together, these three spaces become something rare: a single private companion for your whole inner life of faith. One place that knows your whole journey, because you've been building it, one honest entry at a time.
        </p>
        <p className="text-foreground/75 leading-relaxed">
          A faith that is not just believed but witnessed, in your own story, in your own handwriting. That is enough.
        </p>
      </div>
