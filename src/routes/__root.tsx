...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:description", content: "Your daily space for spiritual growth and reflection." },
      { property: "og:type", content: "website" },
      { property: "og:url", content: "https://www.gracenotesdaily.com" },
      { property: "og:image", content: "https://www.gracenotesdaily.com/icons/icon-512.png" },
      { name: "twitter:image", content: "https://www.gracenotesdaily.com/icons/icon-512.png" },
