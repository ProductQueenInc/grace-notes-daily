...
// Moved from /blog/building-gracenotes-daily on 2026-07-22 so all writing
// lives under /library. The old URL 301s here (src/routes/blog.building-gracenotes-daily.tsx).
const PATH = "/library/building-gracenotes-daily";
...
export const Route = createFileRoute("/library/building-gracenotes-daily")({
  head: () => {
    const articleJsonLd = {
    ...
    const breadcrumbJsonLd = {
      ...
      itemListElement: [
        ...
        { "@type": "ListItem", position: 3, name: "Build guide", item: URL },
      ],
    };
    return {
      meta: [
